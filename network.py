...
predictedTE= predictions[:,1] - predictions[:,0]
n = predictions.shape[0]
predictedOutcomes = np.array([
    predictions[i,happen1[i]]
    for i in range(n)
])
np.mean(abs(choice2 - predictedOutcomes)) 
# out of sample prediction .4 (= terrible  here)
...
#     (e.g. cognition)
# Other datasets: https://www.openicpsr.org/openicpsr/project/221121/version/V1/view?path=/openicpsr/221121/fcr:versions/V1/Replication-Package---Deidentified/README.pdf&type=file